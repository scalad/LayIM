...
layui.use('layim', function(layim){
	...
	layim.config({
	    ...
	    //查看群员接口
	    ,members: {
	      	url: '${pageContext.request.contextPath}/user/getMembers'
	      	,data: {}
	    }
	    
	    //上传图片接口
	    ,uploadImage: {
	      	url: '${pageContext.request.contextPath}/user/upload/image' //（返回的数据格式见下文）
	      	,type: 'post' //默认post
	    } 
	    
	    //上传文件接口
	    ,uploadFile: {
	      	url: '${pageContext.request.contextPath}/user/upload/file' //（返回的数据格式见下文）
	      	,type: 'post' //默认post
	    }
	  ...
	  layim.on('sendMessage', function(data){
		  var mine = data.mine
		  console.log("mine message is " + mine);
	      var To = data.to;
	      console.log(data);
